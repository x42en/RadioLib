...
// yield function #define RADIOLIB_TONE_UNSUPPORTED #define
// RADIOLIB_YIELD_UNSUPPORTED
...
// #define RADIOLIB_EXCLUDE_PAGER            (1)
    ...
    !(defined(ARDUINO_AVR_UNO_WIFI_REV2) || defined(ARDUINO_AVR_NANO_EVERY) || \
...
#define RADIOLIB_ARDUINOHAL_INTERRUPT_MODE_CAST (PinStatus)
    ...
    defined(DARDUINO_ARCH_ASR6601)
// CubeCell
#define RADIOLIB_PLATFORM "CubeCell"
#define RADIOLIB_DEFAULT_SPI_SETTINGS \
  SPISettings(1000000, MSBFIRST, SPI_MODE0) // see issue #709
#define RADIOLIB_ARDUINOHAL_PIN_MODE_CAST (PINMODE)
...
#define RADIOLIB_NONVOLATILE_READ_BYTE(addr) \
  (*(reinterpret_cast<uint8_t *>(reinterpret_cast<void *>(addr))))
#define RADIOLIB_NONVOLATILE_READ_DWORD(addr) \
  (*(reinterpret_cast<uint32_t *>(reinterpret_cast<void *>(addr))))
#define RADIOLIB_TYPE_ALIAS(type, alias) using alias = type;
...
#if (!defined(ARDUINO_ARCH_STM32) || !defined(SUBGHZSPI_BASE)) && \
    !defined(DOXYGEN)
...
#define RADIOLIB_DEBUG_PRINT_LVL(LEVEL, M, ...) \
  rlb_printf(true, LEVEL "" M, ##__VA_ARGS__)
#endif

#if !defined(RADIOLIB_DEBUG_PRINTLN)
#define RADIOLIB_DEBUG_PRINTLN(M, ...) \
  rlb_printf(false, M RADIOLIB_LINE_FEED, ##__VA_ARGS__)
#define RADIOLIB_DEBUG_PRINTLN_LVL(LEVEL, M, ...) \
  rlb_printf(true, LEVEL "" M RADIOLIB_LINE_FEED, ##__VA_ARGS__)
#endif
...
#else
#define RADIOLIB_DEBUG_PRINT_FLOAT(LEVEL, VAL, DECIMALS) \
  RADIOLIB_DEBUG_PRINT(LEVEL "%.3f", VAL)
#endif
...
#define RADIOLIB_DEBUG_BASIC_PRINT(...) \
  RADIOLIB_DEBUG_PRINT_LVL(RADIOLIB_DEBUG_TAG_BASIC, __VA_ARGS__)
#define RADIOLIB_DEBUG_BASIC_PRINTLN(...) \
  RADIOLIB_DEBUG_PRINTLN_LVL(RADIOLIB_DEBUG_TAG_BASIC, __VA_ARGS__)
#define RADIOLIB_DEBUG_BASIC_HEXDUMP(...) \
  RADIOLIB_DEBUG_HEXDUMP(RADIOLIB_DEBUG_TAG_BASIC, __VA_ARGS__)
#define RADIOLIB_DEBUG_BASIC_PRINT_FLOAT(...) \
  RADIOLIB_DEBUG_PRINT_FLOAT(RADIOLIB_DEBUG_TAG_BASIC, __VA_ARGS__)
#define RADIOLIB_DEBUG_BASIC_PRINT_NOTAG(...) RADIOLIB_DEBUG_PRINT(__VA_ARGS__)
#define RADIOLIB_DEBUG_BASIC_PRINTLN_NOTAG(...) \
  RADIOLIB_DEBUG_PRINTLN(__VA_ARGS__)
#else
#define RADIOLIB_DEBUG_BASIC_PRINT(...) \
  {                                     \
  }
...
#define RADIOLIB_DEBUG_PROTOCOL_PRINT(...) \
  RADIOLIB_DEBUG_PRINT_LVL(RADIOLIB_DEBUG_TAG_PROTOCOL, __VA_ARGS__)
#define RADIOLIB_DEBUG_PROTOCOL_PRINTLN(...) \
  RADIOLIB_DEBUG_PRINTLN_LVL(RADIOLIB_DEBUG_TAG_PROTOCOL, __VA_ARGS__)
#define RADIOLIB_DEBUG_PROTOCOL_HEXDUMP(...) \
  RADIOLIB_DEBUG_HEXDUMP(RADIOLIB_DEBUG_TAG_PROTOCOL, __VA_ARGS__)
#define RADIOLIB_DEBUG_PROTOCOL_PRINT_FLOAT(...) \
  RADIOLIB_DEBUG_PRINT_FLOAT(RADIOLIB_DEBUG_TAG_PROTOCOL, __VA_ARGS__)
#define RADIOLIB_DEBUG_PROTOCOL_PRINT_NOTAG(...) \
  RADIOLIB_DEBUG_PRINT(__VA_ARGS__)
#define RADIOLIB_DEBUG_PROTOCOL_PRINTLN_NOTAG(...) \
  RADIOLIB_DEBUG_PRINTLN(__VA_ARGS__)
#define RADIOLIB_DEBUG_PROTOCOL_PRINT_FLOAT_NOTAG(...) \
  RADIOLIB_DEBUG_PRINT_FLOAT("", __VA_ARGS__)
#else
#define RADIOLIB_DEBUG_PROTOCOL_PRINT(...) \
  {                                        \
  }
...
#define RADIOLIB_DEBUG_SPI_PRINT(...) \
  RADIOLIB_DEBUG_PRINT_LVL(RADIOLIB_DEBUG_TAG_SPI, __VA_ARGS__)
#define RADIOLIB_DEBUG_SPI_PRINTLN(...) \
  RADIOLIB_DEBUG_PRINTLN_LVL(RADIOLIB_DEBUG_TAG_SPI, __VA_ARGS__)
#define RADIOLIB_DEBUG_SPI_HEXDUMP(...) \
  RADIOLIB_DEBUG_HEXDUMP(RADIOLIB_DEBUG_TAG_SPI, __VA_ARGS__)
#define RADIOLIB_DEBUG_SPI_PRINT_FLOAT(...) \
  RADIOLIB_DEBUG_PRINT_FLOAT(RADIOLIB_DEBUG_TAG_SPI, __VA_ARGS__)
...
#define RADIOLIB_INFO                                                                                                                     \
  "\r\nRadioLib Info\nVersion:  \"" RADIOLIB_VALUE(RADIOLIB_VERSION_MAJOR) "." RADIOLIB_VALUE(RADIOLIB_VERSION_MINOR) "." RADIOLIB_VALUE( \
      RADIOLIB_VERSION_PATCH) "." RADIOLIB_VALUE(RADIOLIB_VERSION_EXTRA) "\""                                                             \
                                                                         ...
                                                                         "tfo"                                                            \
                                                                         "rm:"                                                            \
                                                                         " " RADIOLIB_VALUE(RADIOLIB_PLATFORM) "\r\n" RADIOLIB_VALUE(     \
...
#define RADIOLIB_ASSERT(STATEVAR)                                     \
  {                                                                   \
    ...
    {                                                                 \
      RADIOLIB_DEBUG_BASIC_PRINTLN("%d at %s:%d", STATEVAR, __FILE__, \
                                   __LINE__);                         \
      return (STATEVAR);                                              \
    }                                                                 \
  }
...
#define RADIOLIB_VERSION                                                 \
  (((RADIOLIB_VERSION_MAJOR) << 24) | ((RADIOLIB_VERSION_MINOR) << 16) | \
   ((RADIOLIB_VERSION_PATCH) << 8) | (RADIOLIB_VERSION_EXTRA))
